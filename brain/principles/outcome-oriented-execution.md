...
- When an internal API is replaced, inventory and migrate its callers, then delete the legacy API in the same refactor wave. Compatibility adapters require a real external constraint and an explicit removal deadline.
